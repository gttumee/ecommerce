...
@section('title','Nimo.mn || Бүртгүүлэх')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Бүртгүүлэх</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>Бүртгүүлэх</h2>
                        <p>Манай дэлгүүрт бүргүүлж байгаад баярлалаа</p>
                        <!-- Form -->
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Нууц үг баталгаажуулах<span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <a href="{{route('login.form')}}" class="btn">Нэвтрэх</a>
                                        эсвэл
