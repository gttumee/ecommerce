                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Нийтлэл</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="{{$post->photo}}" alt="{{$post->photo}}">
                                    <div class="content">
                                        ...
                                        <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Үргэлжлүүлэх</a>
                                    </div>
                                </div>
                                <!-- End Single Blog  -->
                            </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Нийтлэлийн Ангилал</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">МЭДЭЭЛЭЛ АВАХ</h3>
                            <div class="letter-inner">
                                <h4>И-мэйл хаягаараа<br> шинэ Нийтлэлүүдийг авах.</h4>
                                <form method="POST" action="{{route('subscribe')}}" class="form-inner">
                                    @csrf
                                    <input type="email" name="email" placeholder="И-мэйл оруулна уу">
                                    <button type="submit" class="btn " style="width: 100%">Бүртгүүлэх</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
