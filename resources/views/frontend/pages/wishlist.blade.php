...
@section('title','Nimo.mn || Таалагдсан бараа')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Таагагдсан бараа</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">Сагсанд хийх</th> 
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Сагсанд хийх</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Таалагдсан жагсаалтад бараа байхгүй байна. <a href="{{route('product-grids')}}" style="color:blue;">Худалдаа үргэлжлүүлэх</a>
