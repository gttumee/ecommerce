								...
								@if(Helper::getAllProductFromCart())
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit">Шинчлэх</button>
										</td>
									</track>
								@else
										<tr>
											<td class="text-center">
												Таны сагсанд бараа байхгүй байна. <a href="{{route('product-grids')}}" style="color:blue;">Дэлгүүр рүү буцах</a>
					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Хөнгөлөлтийн дугаар">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Нийт төлбөр<span>{{number_format(Helper::totalCartPrice(),2)}}₮</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Нийт төлөх<span>{{number_format(Session::get('coupon')['value'],2)}}₮</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Таны төлөх<span>{{number_format($total_amount,2)}}₮</span></li>
										@else
											<li class="last" id="order_total_price">Таны төлөх<span>{{number_format($total_amount,2)}}₮</span></li>
										@endif
									</ul>
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn">Захиалах</a>
										<a href="{{route('product-grids')}}" class="btn">Дэлгүүр буцах</a>
									</div>
								</div>
							</div>
						</div>
